...
/** Keeps the entity area around the real player visible while the camera is displaced. */
public final class EntityVisibility {
    ...
    public static boolean isProtected(Entity entity) {
        ...
        return Mod.enabled
                && client.player != null
                && (entity == client.player || entity.squaredDistanceTo(client.player) <= PROTECTED_RADIUS_SQUARED);
    }
