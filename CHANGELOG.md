...
- 新增 Ctrl + 滚轮缩放操作；关闭滚轮缩放后，可用滚轮切换快捷栏物品并按住 Ctrl 缩放。
- 地牢视角的位置音效统一按配置的听觉位置播放，修复镜头拉远后原版攻击、弓箭及其他玩家附近音效被相机距离过滤的问题。

## 2.1.4

- 修复镜头拉远后 Better Combat 近战音效被额外延迟，以及弓箭等玩家附近音效被距离过滤的问题。

## 2.1.3

- 修复方块遮挡镜头时形状剔除未被应用的问题。
